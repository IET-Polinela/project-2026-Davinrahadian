...
class Command(BaseCommand):
    help = 'Generate contextual fake reports for IET Smart City'
    ...
    def handle(self, *args, **kwargs):
        ...
        context_data = {
            'Jalan Rusak': {
                ...
                'desc': (
                    'Ditemukan kerusakan jalan yang cukup dalam. Mohon segera '
                    'diperbaiki sebelum memakan korban jiwa atau merusak kendaraan warga.'
                ),
            },
            'Sampah': {
                'titles': [
                ...
                'desc': (
                    'Warga mengeluhkan penumpukan sampah yang belum diangkut selama '
                    'lebih dari 3 hari. Bau mulai menyengat dan mengganggu aktivitas.'
                ),
            },
            'Lampu Mati': {
                'titles': [
                ...
                'desc': (
                    'Lampu jalan di area ini mati total sejak kemarin malam. Kondisi '
                    'jalan menjadi gelap gulita dan membahayakan pengguna jalan.'
                ),
            },
            'Drainase': {
                'titles': [
                ...
                'desc': (
                    'Saluran air tersumbat sehingga setiap kali hujan turun, air meluap '
                    'ke badan jalan dan masuk ke teras rumah warga sekitar.'
                ),
            },
            'Keamanan': {
                'titles': [
